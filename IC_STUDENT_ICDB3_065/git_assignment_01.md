...
```
### Example:
![screenshot](screenshot/git_install.png)
### 2. git version check
...
```
### Example:
![screenshot](screenshot/git_config.png)
### 4. git init 
...
```
### Example:
![screenshot](screenshot/git_init.png)
### 5. git add 
...
```
### Example:
![screenshot](screenshot/git_add.png)
### 6. git commit 
...
```
### Example:
![screenshot](screenshot/git_commit.png)
### 7. ssh-keygen 
...
```
### Example:
![screenshot](screenshot/ssh_keygen.png)
### 8. ssh-connect 
...
```
### Example:
![screenshot](screenshot/ssh_connect_github.png)
### 9. git clone
...
```
### Example:
![screenshot](screenshot/git_clone.png)
### 10. git remote
...
```
### Example:
![screenshot](screenshot/git_remote.png)

![screenshot](screenshot/git_remote_origin.png)
...
```
### Example:
![screenshot](screenshot/git_remote_remove.png)
### 12. git branch
...
```
### Example:
![screenshot](screenshot/creatingbranch.png)
### 13. git merge
...
```
### Example:
![screenshot](screenshot/git_merge.png)
...
```
### Example:
![screenshot](screenshot/delete_branch.png)
### 15. git log
...
```
### Example:
![screenshot](screenshot/git_log.png)
### 16. git log --oneline
...
```
### Example:
![screenshot](screenshot/git_oneline.png)
### 17. git push
...
```
### Example:
![screenshot](screenshot/git_push.png)
### 18. git pull
...
```
### Example:
![screenshot](screenshot/git_pull.png)
### 19. git status
...
```
### Example:
![screenshot](screenshot/git_status.png)
### 20. git show
...
```
### Example:
![screenshot](screenshot/git_show.png)
### 21. git reset
...
```
### Example:
![screenshot](screenshot/git_reset.png)

![screenshot](screenshot/git_reset_hard.png)
### 22. git revert
...
```
### Example:
![screenshot](screenshot/git_revert.png)
### 23. git rebase
...
```
### Example:
![screenshot](screenshot/git_rebase.png)
### 24. git ignore
...
```
### Example:
![screenshot](screenshot/git_gitignore_command.png)

![screenshot](screenshot/git_ignore.png)
### 25. git HEAD
...
```
### Example:
![screenshot](screenshot/git_head.png)
### 26. git amend
...
```
### Example:
![screenshot](screenshot/git_amend.png)
### 27. git blame
...
```
### Example:
![screenshot](screenshot/git_blame.png)
### 28. git tag
...
```
### Example:
![screenshot](screenshot/git_tag.png)
### 29. git stash
...
```
### Example:
![screenshot](screenshot/git_stash.png)
### 30. git conflict
...
```
### Example:
![screenshot](screenshot/git_conflict.png)

![screenshot](screenshot/git_conflict_vi.png)
### 31. git fetch
...
```
### Example:
![screenshot](screenshot/git_fetch.png)
### 32. git cherry-pick
...
```
### Example:
![screenshot](screenshot/git_cherry-pick.png)
### 33. git keep
...
```
### Example:
![screenshot](screenshot/git_keep.png)
### 34. git clean
...
```
### Example:
![screenshot](screenshot/git_clean.png)
### 35. git diff
...
```
### Example:
![screenshot](screenshot/git_diff.png)
### 36. git ls -la
...
```
### Example:
![screenshot](screenshot/git_ls_la.png)
### 37. git help
...
```
### Example:
![screenshot](screenshot/git_help.png)
